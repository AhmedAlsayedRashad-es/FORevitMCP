...
| 4 | .NET 8 SDK | Builds the MCP server and the Revit add-in (Revit 2021-2026) | `winget install --id Microsoft.DotNet.SDK.8 -e` |
| 4b | .NET 10 SDK | Builds the add-in for Revit 2027 | `winget install --id Microsoft.DotNet.SDK.10 -e` |
