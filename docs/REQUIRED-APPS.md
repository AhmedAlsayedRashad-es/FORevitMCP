...
| 2 | pyRevit (5.x or later) | Runs the bridge (pyRevit Routes) | `winget install --id pyRevit.pyRevit -e` or the installer from https://github.com/pyrevitlabs/pyRevit/releases |
