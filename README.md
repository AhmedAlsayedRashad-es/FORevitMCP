...
| `src/Addin` | The Revit add-in: ribbon tab "First Option", dockable MCP panel, GitHub Settings window, Roslyn C# runner. Revit 2021-2027 (2021-2024: .NET Framework 4.8, 2025-2026: .NET 8, 2027: .NET 10) |
...
3. Builds the add-in for Revit 2021 to 2027, whether or not that Revit is on the computer, copies it to `%LOCALAPPDATA%\First Option\RevitMCP\Revit Add-in\<version>`, and writes `FirstOption.RevitMcp.addin` in `%APPDATA%\Autodesk\Revit\Addins\<version>`.
